...
const STUDENTS_DATA = [
  { firstName: "An", lastName : 'Hello', batch : 1 , age: 20 ,},
  { firstName: "Bình", lastName : 'Hi', batch : 2 , age: 22 },
  { firstName: "Cẩm", lastName : 'Smos', batch : 3 , age: 21 },
  { firstName: "An", lastName : 'ty', batch : 4 , age: 19 }, // Duplicate first name !
];
...
updateStudentAge("An", "Hello" , 1 ,  30);
